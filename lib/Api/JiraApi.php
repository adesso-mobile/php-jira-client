...
use JiraClient\HeaderSelector;
use JiraClient\ObjectSerializer;

/**
 * JiraApi Class Doc Comment
 *
 * @category Class
 * @package  JiraClient
 * @author   OpenAPI Generator team
...
class JiraApi
{
     ...
     *
     * @param  bool $update_history if true then the user&#39;s project history is updated (optional, default to false)
     * @param  \JiraClient\Model\JiraIssueCreationProperties $issue The specification of the issue to create (optional)
     *
    ...
    {
        list($response) = $this->createIssueWithHttpInfo($update_history, $issue);
        return $response;
    }
     ...
     */
    public function createIssueAsync($update_history = false, $issue = null)
    {
        return $this->createIssueAsyncWithHttpInfo($update_history, $issue)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function createIssueRequest($update_history = false, $issue = null)
    {
        ...
        // query params
        if ($update_history !== null) {
            $queryParams['updateHistory'] = ObjectSerializer::toQueryValue($update_history);
        }
